...
I followed [this post](https://cran.r-project.org/web/packages/FunnelPlotR/vignettes/changing_funnel_plot_options.html) to set up the theme using usual valid ggplot2 theme to be passed to the plot later.
...
To plot the funnel plot from scratch, we need to derive **cumulative death rate** (rate) and **standard error of cumulative death rate** (rate.se).
